package lesson06.f_explicit_wait_helps_to_be_careful_with_el_copy;
...
//        driver.manage().timeouts().setScriptTimeout(10,TimeUnit.SECONDS);
    ...
    public void firstResultShoudContainExpectedText() throws InterruptedException {
        ...
        (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.textToBePresentInElement(driver.findElement(By.xpath("//*[@id=\"index\"]/div[2]/ul/li[1]")), query1));
